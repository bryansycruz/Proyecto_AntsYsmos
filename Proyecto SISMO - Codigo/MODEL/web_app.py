...
app = Flask(__name__) #Para que capture el modelo
app.config["SECRET_KEY"] = "you-will-never-guess" #La clave que se le da al sistema para que solo yo pueda entrar

#Esto me dara un enlace de la pagina privado "http://127.0.0.1:5000/index" y la pagina se llama /index


#*******************python MODEL/web_app.py***** para correr la pagina en la terminal*******************
...
################################################
    ...
    return render_template("index.html") #Esto me lee los datos del archivo 
